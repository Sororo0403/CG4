...
inline DirectX::XMFLOAT3 LerpClamped(const DirectX::XMFLOAT3 &a,
                                     const DirectX::XMFLOAT3 &b, float t) {
    return Lerp(a, b, SaturateFinite(t));
}

inline DirectX::XMFLOAT4 Lerp(const DirectX::XMFLOAT4 &a,
                              const DirectX::XMFLOAT4 &b, float t) {
    return {Lerp(a.x, b.x, t), Lerp(a.y, b.y, t),
            Lerp(a.z, b.z, t), Lerp(a.w, b.w, t)};
}

inline DirectX::XMFLOAT4 LerpClamped(const DirectX::XMFLOAT4 &a,
                                     const DirectX::XMFLOAT4 &b, float t) {
    return Lerp(a, b, SaturateFinite(t));
}

constexpr DirectX::XMFLOAT3 Add(const DirectX::XMFLOAT3 &a,
                                const DirectX::XMFLOAT3 &b) {
    return {a.x + b.x, a.y + b.y, a.z + b.z};
}

constexpr DirectX::XMFLOAT3 Subtract(const DirectX::XMFLOAT3 &a,
                                     const DirectX::XMFLOAT3 &b) {
    return {a.x - b.x, a.y - b.y, a.z - b.z};
}

constexpr DirectX::XMFLOAT3 Scale(const DirectX::XMFLOAT3 &value,
                                  float scale) {
    return {value.x * scale, value.y * scale, value.z * scale};
}

constexpr float Dot(const DirectX::XMFLOAT3 &a,
                    const DirectX::XMFLOAT3 &b) {
    return a.x * b.x + a.y * b.y + a.z * b.z;
}

constexpr DirectX::XMFLOAT3 Cross(const DirectX::XMFLOAT3 &a,
                                  const DirectX::XMFLOAT3 &b) {
...
NormalizeOrDefault(const DirectX::XMFLOAT3 &value,
...
inline float DistanceXZ(const DirectX::XMFLOAT3 &a,
                        const DirectX::XMFLOAT3 &b) {
...
inline DirectX::XMFLOAT3
NormalizeXZOrDefault(const DirectX::XMFLOAT3 &value,
                     const DirectX::XMFLOAT3 &fallback) {
...
inline float VerticalScaleFromWorld(const DirectX::XMFLOAT4X4 &world) {
    return std::sqrt(world._21 * world._21 + world._22 * world._22 +
                     world._23 * world._23);
}
...
constexpr float SmoothStep01(float value) {
    return SmoothStepUnclamped(
        IsFinite(value) ? Saturate(value) : 0.0f);
}
