...
inline void Set(const TextureManager *textureManager,
                ...
                DirectX::XMFLOAT4X4 &targetLightViewProjection,
                DirectX::XMFLOAT4 &targetParams,
    ...
    targetFilterParams = {
        Numeric::AtLeastFinite(settings.filterRadius, 0.0f, 0.0f),
